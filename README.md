...
**Common event types:** `CONNECTED` · `STRATEGY_STARTED` · `STRATEGY_PAUSED` · `STRATEGY_RESUMED` · `STRATEGY_STOPPED` · `STRATEGY_ERROR` · `ORDER_SUBMITTED` · `ORDER_PLACED` · `ORDER_PARTIAL` · `ORDER_FILLED` · `ORDER_CANCELLED` · `ORDER_FAILED` · `ORDER_ERROR` · `BACKTEST_PROGRESS` · `BACKTEST_COMPLETED` · `BACKTEST_FAILED`

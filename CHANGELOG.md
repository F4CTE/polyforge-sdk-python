...
- **#548 EIP-712 private key string copies** — eliminated redundant Buffer-to-string conversion in eip712Sign, documented accepted JS limitation with TODO for Rust NAPI migration

...
async function main() {
    ...
    const backtestOrdersData = [
        { id: IDS.btOrder1, runId: IDS.backtest2, tokenId: MARKETS.usElections.tokenYes, side: 'BUY', outcome: 'YES', size: '50.000000', price: '0.580000', fillPrice: '0.582000', pnl: '12.500000', equityCurve: '12.500000', simulatedAt: daysAgo(55) },
        { id: IDS.btOrder2, runId: IDS.backtest2, tokenId: MARKETS.usElections.tokenYes, side: 'SELL', outcome: 'YES', size: '50.000000', price: '0.620000', fillPrice: '0.618000', pnl: '18.000000', equityCurve: '30.500000', simulatedAt: daysAgo(50) },
        { id: IDS.btOrder3, runId: IDS.backtest2, tokenId: MARKETS.cryptoEtf.tokenYes, side: 'BUY', outcome: 'YES', size: '100.000000', price: '0.400000', fillPrice: '0.402000', pnl: '-8.200000', equityCurve: '22.300000', simulatedAt: daysAgo(45) },
        { id: IDS.btOrder4, runId: IDS.backtest2, tokenId: MARKETS.usElections.tokenYes, side: 'BUY', outcome: 'YES', size: '75.000000', price: '0.650000', fillPrice: '0.652000', pnl: '35.100000', equityCurve: '57.400000', simulatedAt: daysAgo(40) },
        { id: IDS.btOrder5, runId: IDS.backtest2, tokenId: MARKETS.cryptoEtf.tokenYes, side: 'SELL', outcome: 'YES', size: '100.000000', price: '0.450000', fillPrice: '0.448000', pnl: '44.600000', equityCurve: '102.000000', simulatedAt: daysAgo(30) },
    ];
    ...
    // Start at 0, random walk with slight upward drift
    {
        ...
        for (let i = 30; i >= 1; i--) {
            ...
            if (change > 0)
                realizedPnl += change * 0.3; // 30% of gains are realized
    ...
    const templates = [
        ...
        },
        {
            ...
            blocks: JSON.stringify({
                ...
                actions: [
                    { id: 'a1', type: 'set_stop_loss', params: { pct: '0.10' } },
                    { id: 'a2', type: 'take_profit', params: { pct: '0.20' } },
                ],
                safety: [
    ...
    for (const tmpl of templates) {
        await prisma.strategy.upsert({
            ...
            create: {
                ...
                template: tmpl.isTemplate ?? tmpl.template ?? false,
                visibility: tmpl.visibility,
                userId: tmpl.userId,
                execMode: tmpl.execMode,
                tickMs: tmpl.tickMs,
                safety: tmpl.blocks ? JSON.parse(tmpl.blocks).safety ?? [] : [],
                triggers: tmpl.blocks ? JSON.parse(tmpl.blocks).triggers ?? [] : [],
                conditions: tmpl.blocks ? JSON.parse(tmpl.blocks).conditions ?? [] : [],
                actions: tmpl.blocks ? JSON.parse(tmpl.blocks).actions ?? [] : [],
                status: 'IDLE',
                version: 1,
    ...
    const realTokens = realMarkets.length > 0
        ...
        : [];
    const tokenForMarket = (mktId, outcome = 'YES') => realTokens.find((t) => t.marketId === mktId && t.outcome === outcome)?.id ?? 'token_placeholder';
    const newsArticles = [
        {
            id: 'news-seed-001',
            source: 'Reuters',
            title: 'Netanyahu faces mounting pressure as ceasefire deadline looms',
            summary: 'Israeli PM Netanyahu is under increasing domestic and international pressure to finalize a ceasefire agreement before the March 31 deadline. Analysts say the outcome could shift prediction market odds significantly, with current YES prices hovering around 65 cents.',
        ...
        },
        {
            ...
            summary: 'Bitcoin climbed above $92,000 for the first time in three weeks, driven by record-breaking institutional ETF inflows of $1.2 billion in a single day. Polymarket traders are repricing crypto-related contracts as momentum builds toward the $100K barrier.',
        ...
        },
        {
            ...
            summary: 'A string of upsets in the Sweet Sixteen has dramatically shifted the NCAA tournament landscape. No. 11 seed VCU stunned top-seeded Duke, while No. 7 Clemson knocked off No. 2 Arizona. Prediction markets are repricing championship futures across the board.',
        ...
        },
        {
            ...
            summary: 'The Federal Reserve\'s preferred inflation gauge, core PCE, came in at 2.1% year-over-year — below the 2.3% consensus. Multiple Fed governors have signaled openness to a June rate cut. Bond markets rallied immediately on the news.',
        ...
        },
        {
            ...
            summary: 'OpenAI unveiled GPT-5 today, featuring what the company calls "continuous reasoning." The launch sent prediction market contracts on AI milestones surging, with "AGI by 2027" jumping 12 percentage points.',
        ...
        },
        {
            ...
            summary: 'US military assets have been repositioned in the Persian Gulf region amid heightened tensions with Iran. The Pentagon described the move as "routine readiness adjustments" but prediction market odds on military action have ticked upward by 8 points.',
        ...
        },
        {
            ...
            summary: 'The S&P 500 closed at a record 5,847, boosted by better-than-expected earnings from Nvidia, Microsoft, and Amazon. Prediction market contracts on "S&P above 6000 by June" moved to 72 cents.',
        ...
        },
        {
            ...
            summary: 'Combined transaction volume across Ethereum L2 networks (Arbitrum, Optimism, Base, zkSync) has officially exceeded Ethereum mainnet daily throughput. This milestone reignites the debate around ETH value accrual.',
        ...
        },
        {
            ...
            summary: 'The LA Clippers completed a blockbuster deal acquiring a top defensive wing. Sportsbooks and prediction markets alike have adjusted — Clippers championship futures moved from +2200 to +1400 overnight.',
        ...
        },
        {
            ...
            summary: 'The US Senate voted 68-32 to pass the Digital Asset Market Structure Act, providing the first comprehensive regulatory framework for cryptocurrencies. The bill now heads to the House. Crypto markets rallied on the news.',
    ...
    if (realMarkets.length >= 4) {
        const whaleAlerts = [
            { walletAddress: '0x1234567890abcdef1234567890abcdef12345678', marketId: realMarkets[0].id, tokenId: tokenForMarket(realMarkets[0].id, 'YES'), side: 'BUY', outcome: 'YES', size: 85000, price: 0.65, notional: 55250, detectedAt: hoursAgo(0.5) },
            { walletAddress: '0x1234567890abcdef1234567890abcdef12345678', marketId: realMarkets[1].id, tokenId: tokenForMarket(realMarkets[1].id, 'YES'), side: 'BUY', outcome: 'YES', size: 120000, price: 0.42, notional: 50400, detectedAt: hoursAgo(2) },
            { walletAddress: '0xdeadbeef00000000000000000000000000000001', marketId: realMarkets[2].id, tokenId: tokenForMarket(realMarkets[2].id, 'NO'), side: 'SELL', outcome: 'NO', size: 200000, price: 0.35, notional: 70000, detectedAt: hoursAgo(1) },
            { walletAddress: '0xdeadbeef00000000000000000000000000000001', marketId: realMarkets[0].id, tokenId: tokenForMarket(realMarkets[0].id, 'YES'), side: 'BUY', outcome: 'YES', size: 50000, price: 0.67, notional: 33500, detectedAt: hoursAgo(4) },
            { walletAddress: '0xWhaleAlpha000000000000000000000000000001', marketId: realMarkets[3].id, tokenId: tokenForMarket(realMarkets[3].id, 'YES'), side: 'BUY', outcome: 'YES', size: 75000, price: 0.55, notional: 41250, detectedAt: hoursAgo(0.75) },
            { walletAddress: '0xWhaleAlpha000000000000000000000000000001', marketId: realMarkets[Math.min(4, realMarkets.length - 1)].id, tokenId: tokenForMarket(realMarkets[Math.min(4, realMarkets.length - 1)].id, 'YES'), side: 'BUY', outcome: 'YES', size: 60000, price: 0.72, notional: 43200, detectedAt: hoursAgo(3) },
            { walletAddress: '0xMobyDick0000000000000000000000000000001', marketId: realMarkets[0].id, tokenId: tokenForMarket(realMarkets[0].id, 'YES'), side: 'BUY', outcome: 'YES', size: 300000, price: 0.65, notional: 195000, detectedAt: hoursAgo(0.25) },
            { walletAddress: '0xMobyDick0000000000000000000000000000001', marketId: realMarkets[1].id, tokenId: tokenForMarket(realMarkets[1].id, 'YES'), side: 'SELL', outcome: 'YES', size: 150000, price: 0.78, notional: 117000, detectedAt: hoursAgo(1) },
            { walletAddress: '0xMobyDick0000000000000000000000000000001', marketId: realMarkets[2].id, tokenId: tokenForMarket(realMarkets[2].id, 'NO'), side: 'BUY', outcome: 'NO', size: 180000, price: 0.31, notional: 55800, detectedAt: hoursAgo(5) },
            { walletAddress: '0xBigFish00000000000000000000000000000001', marketId: realMarkets[3].id, tokenId: tokenForMarket(realMarkets[3].id, 'YES'), side: 'BUY', outcome: 'YES', size: 45000, price: 0.60, notional: 27000, detectedAt: hoursAgo(4) },
            { walletAddress: '0xDeepBlue0000000000000000000000000000001', marketId: realMarkets[Math.min(4, realMarkets.length - 1)].id, tokenId: tokenForMarket(realMarkets[Math.min(4, realMarkets.length - 1)].id, 'YES'), side: 'SELL', outcome: 'YES', size: 95000, price: 0.48, notional: 45600, detectedAt: hoursAgo(3) },
            { walletAddress: '0xDeepBlue0000000000000000000000000000001', marketId: realMarkets[0].id, tokenId: tokenForMarket(realMarkets[0].id, 'YES'), side: 'BUY', outcome: 'YES', size: 110000, price: 0.66, notional: 72600, detectedAt: hoursAgo(6) },
            { walletAddress: '0xKrakenWallet000000000000000000000000001', marketId: realMarkets[1].id, tokenId: tokenForMarket(realMarkets[1].id, 'YES'), side: 'BUY', outcome: 'YES', size: 38000, price: 0.43, notional: 16340, detectedAt: hoursAgo(6) },
            { walletAddress: '0xLeviathan000000000000000000000000000001', marketId: realMarkets[2].id, tokenId: tokenForMarket(realMarkets[2].id, 'NO'), side: 'BUY', outcome: 'NO', size: 65000, price: 0.28, notional: 18200, detectedAt: hoursAgo(8) },
            { walletAddress: '0xLeviathan000000000000000000000000000001', marketId: realMarkets[3].id, tokenId: tokenForMarket(realMarkets[3].id, 'YES'), side: 'SELL', outcome: 'YES', size: 42000, price: 0.71, notional: 29820, detectedAt: hoursAgo(10) },
        ];

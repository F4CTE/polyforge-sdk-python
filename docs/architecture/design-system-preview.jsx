...
const ColorSwatch = ({ hex, name, sub }) => (
  ...
  >
    ...
    />
    <div>
      <div style={{ fontFamily: mono, fontSize: 12, color: T.textPrimary }}>
        {hex}
      </div>
      <div style={{ fontFamily: sans, fontSize: 11, color: T.textMuted }}>
        {name}
        {sub ? ` — ${sub}` : ""}
      </div>
    </div>
...
const Badge = ({ label, bg, color, dot }) => (
  ...
  >
    {dot && (
      <div
        className={dot === "pulse" ? "running-dot" : ""}
        style={{
          width: 6,
          height: 6,
          borderRadius: "50%",
  ...
  <div className="section-enter">
    <Section title="Familles de polices">
      ...
      >
        ...
        >
          Automated trading for Polymarket
        </div>
        <div
          style={{
            fontFamily: sans,
        ...
        >
          Create, backtest, and deploy strategies with a drag-and-drop block
          editor.
        </div>
      </div>
      <div
      ...
      >
        ...
        >
          JetBrains Mono — Prix / P&L / Données
        </div>
        <div
          style={{
            fontFamily: mono,
      ...
      {[
        {
          size: 36,
          weight: 700,
          label: "3xl — Titre principal",
          text: "Portfolio",
        },
        {
          size: 28,
          weight: 600,
          label: "2xl — Titre de page",
          text: "My Strategies",
        },
        {
          size: 22,
          weight: 600,
          label: "xl — Section title",
        ...
        },
        {
          ...
          weight: 600,
          label: "lg — Card title",
          text: "Price Crosses Up",
        },
        {
          size: 15,
          weight: 500,
          label: "md — Body emphasis",
          text: "Strategy is running",
        },
        {
          size: 14,
          weight: 400,
          label: "base — Body text",
          text: "Place a buy order when price crosses above the threshold.",
        },
        {
          size: 12,
          weight: 400,
        ...
        >
          ...
          <div
            style={{
              fontFamily: size === 11 ? sans : sans,
              fontSize: size,
              fontWeight: weight,
              color: T.textPrimary,
              letterSpacing: size === 11 ? "0.08em" : 0,
      ...
      <Section title="Inputs">
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <input
            ...
            onFocus={(e) => {
              e.target.style.borderColor = T.cyan500;
              e.target.style.boxShadow = "0 0 0 2px rgba(6,182,212,0.15)";
            }}
            onBlur={(e) => {
          ...
          />
          <div style={{ fontFamily: sans, fontSize: 12, color: T.danger }}>
  ...
  const strategies = [
    {
      name: "Momentum Blitz",
      status: "RUNNING",
      statusColor: T.cyan500,
      statusBg: "rgba(6,182,212,0.12)",
      pnl: "+$124.50",
      pct: "+8.34%",
      positive: true,
      market: "US Elections 2026",
      mode: "TICK",
    },
    {
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontFamily: sans, fontSize: 10, color: T.success }}>
              ● Connected
            </div>
          </div>
        </div>
            ...
            {strategies.map((s) => (
              ...
              >
                ...
                <div>
                  ...
                  >
                    <div
                      className={s.status === "RUNNING" ? "running-dot" : ""}
                      style={{
                        width: 5,
                        height: 5,
                        borderRadius: "50%",
                ...
                <div>
                  <div
                    style={{
                      ...
                      fontSize: 13,
                      fontWeight: 500,
                      color: s.positive ? T.success : T.danger,
                    }}
                  >
                    {s.pnl}
                  </div>
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        >
          ...
          <div>
            ...
            >
              Polyforge Design System
            </div>
            <div style={{ fontFamily: sans, fontSize: 12, color: T.textMuted }}>
              Dark · Cyan · "Precision Instrument"
            </div>
          </div>
        ...
        {TABS.map((t, i) => (
          <button
            ...
            style={{
              ...
              borderBottom:
                tab === i ? `2px solid ${T.cyan500}` : "2px solid transparent",
              cursor: "pointer",
              marginBottom: -1,
            }}
          >

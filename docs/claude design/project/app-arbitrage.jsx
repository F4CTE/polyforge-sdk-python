          ...
          {tab === 'single' ? (
            ...
            <p>
              ...
              buy the underpriced side on one venue and sell (or hedge) on the other. Match confidence reflects how closely the two
               listings track the same underlying outcome — <span className="mono">≥80%</span> match confidence indicates a likely mapping, but does not measure execution or counterparty safety. Always verify liquidity and trade conditions independently.
            </p>
          )}
        </div>
      </div>

...
This project is indexed by GitNexus as **polyforge-sdk-python** (747 symbols, 2015 relationships, 67 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/polyforge-sdk-python/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/polyforge-sdk-python/context` | Codebase overview, check index freshness |
| `gitnexus://repo/polyforge-sdk-python/clusters` | All functional areas |
| `gitnexus://repo/polyforge-sdk-python/processes` | All execution flows |
| `gitnexus://repo/polyforge-sdk-python/process/{name}` | Step-by-step execution trace |

...
let AiService = AiService_1 = class AiService {
        ...
        this.patterns = [
            {
                ...
                action: async (userId) => {
                    const strategies = await this.prisma.strategy.findMany({
                        where: { userId, status: client_1.StrategyStatus.RUNNING },
    ...
    async query(userId, queryText) {
        ...
        return {
            ...
            filters: {},
            data: null,
            summary: "I didn't understand that query. Try asking about: strategies, portfolio, orders, whale trades, news signals, scores, alerts, copy trading, or markets.",
        };
    }
};

...
export class StrategiesController {
    ...
    @Patch(':id')
    update(@Param('id', ParseUUIDPipe) id: string, @CurrentUser() user: any, @Body() dto: UpdateStrategyDto) {
    ...
    @Post(':id/start')
    start(@Param('id', ParseUUIDPipe) id: string, @CurrentUser() user: any, @Body() dto: StartStrategyDto) {
    ...
    @Get(':id/comments')
    listComments(@Param('id', ParseUUIDPipe) id: string, @Query() query: PaginationDto) {
    ...
    @Post(':id/report')
    @HttpCode(HttpStatus.CREATED)
    report(@Param('id', ParseUUIDPipe) id: string, @CurrentUser() user: any, @Body() dto: ReportStrategyDto) {

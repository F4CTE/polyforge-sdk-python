...
export function emailVerificationFactory(
  overrides: Partial<EmailVerificationLike> = {},
): EmailVerificationLike {
  return {
    id: fakeUuid(),
    userId: fakeUuid(),
...
export function passwordResetTokenFactory(
  overrides: Partial<PasswordResetTokenLike> = {},
): PasswordResetTokenLike {
  return {
    id: fakeUuid(),
    userId: fakeUuid(),
    tokenHash: fakeHex(64),

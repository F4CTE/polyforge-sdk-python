...
export class EventsService {
    ...
    async emitOrderPlaced(userId: string, orderId: string, intentId: string): Promise<void> {
    ...
    async emitOrderFailed(userId: string, orderId: string, reason: string): Promise<void> {
        await this.redis.xadd(STREAM, {
            type:    'ORDER_FAILED',
            userId,
            orderId,

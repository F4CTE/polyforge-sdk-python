          ...
          <div className="bg-elevated border border-default rounded-pf-lg p-5">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                className={`transition-colors ${isSuperAdmin ? 'cursor-pointer text-accent hover:text-accent-text' : 'text-tertiary opacity-50 cursor-not-allowed'}`}
              ...
              >
                {config?.inviteOnly ? (
                  ...
                  <ToggleLeft size={32} className="text-tertiary" />
                )}
              </Button>
            </div>
          </div>

    ...
    >
      ...
      <div className="px-2 py-1 space-y-0.5">
        <a
          ...
          className="flex items-center gap-3 px-3 py-2 rounded-sm text-label transition-colors duration-micro text-tertiary hover:bg-elevated hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:rounded-pf"
        >
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 rounded-sm text-label transition-colors duration-micro text-tertiary hover:bg-elevated hover:text-primary w-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:rounded-pf"

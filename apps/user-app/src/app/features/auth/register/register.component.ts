...
export class RegisterComponent {
  ...
  submit(): void {
    ...
    const { email, username, password, tosAccepted } = this.form.value;

    this.auth.register({ email: email!, username: username!, password: password!, tosAccepted: tosAccepted! }).subscribe({

    ...
    <div className="min-h-screen bg-app text-primary">
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="space-y-8 text-body-sm text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">6. Trading Risks</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">7. Copy Trading</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">8. API Access</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">9. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">10. Fees and Payments</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">14. Governing Law</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">15. Changes to Terms</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">16. Contact</h2>
            <p>For questions about these terms, contact us at <a href="mailto:legal@polyforge.app" className="text-accent-text hover:underline">legal@polyforge.app</a>.</p>
          </section>
        </div>

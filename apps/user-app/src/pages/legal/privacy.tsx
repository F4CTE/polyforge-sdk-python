  ...
  return (
    <div className="min-h-screen bg-pf-base text-pf-text">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <h1 className="text-2xl font-semibold text-pf-text mb-2">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-sm text-pf-text-secondary leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-pf-text mb-3">1. Overview</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-pf-text mb-3">2. Information We Collect</h2>
            <h3 className="text-base font-medium text-pf-text mt-4 mb-2">2.1 Account Information</h3>
            ...
            <h3 className="text-base font-medium text-pf-text mt-4 mb-2">2.2 Usage Data</h3>
          ...
          <section>
            <h2 className="text-lg font-semibold text-pf-text mb-3">3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-pf-text mb-3">4. Legal Bases for Processing (GDPR)</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-pf-text mb-3">5. Data Retention</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-pf-text mb-3">6. Data Sharing</h2>
            <p className="mb-2">We share your data only with:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><strong className="text-pf-text">Infrastructure providers</strong> -- cloud hosting, database, and email delivery vendors operating under data processing agreements;</li>
          ...
          <section>
            <h2 className="text-lg font-semibold text-pf-text mb-3">8. Cookies and Local Storage</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-pf-text mb-3">9. Your Rights</h2>
            ...
            <p className="mt-3">To exercise these rights, email <a href="mailto:privacy@polyforge.app" className="text-pf-cyan-400 hover:underline">privacy@polyforge.app</a>. We will respond within 30 days.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-pf-text mb-3">10. Children's Privacy</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-pf-text mb-3">11. Changes to This Policy</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-pf-text mb-3">12. Contact</h2>
            <p>For privacy-related questions or requests, contact: <a href="mailto:privacy@polyforge.app" className="text-pf-cyan-400 hover:underline">privacy@polyforge.app</a>.</p>
          </section>
        </div>

        {/* Footer */}
        <div className="flex items-center gap-3 mt-12 pt-6 border-t border-pf-border-subtle text-sm text-pf-text-muted">
          <Link to="/terms" className="hover:text-pf-text transition-colors">Terms of Service</Link>
          <span>&middot;</span>

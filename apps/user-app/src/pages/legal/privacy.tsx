    ...
    <div className="min-h-screen bg-app text-primary">
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <nav aria-label="Legal pages" className="flex items-center gap-3 mt-12 pt-6 border-t border-subtle text-sm text-tertiary">
          <Link to="/terms" className="hover:text-primary transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 rounded-pf-sm">Terms of Service</Link>

...
function SectionHeader({ title }: { title: string }) {
  return <h2 className="text-xl font-bold text-pf-text mb-5">{title}</h2>;
}
...
export function Component() {
  ...
  function renderContent() {
    ...
    if (activeId === 'sdks') return (
      <div className="space-y-5">
        <SectionHeader title="SDKs & Clients" />
        <p className="text-sm text-pf-text-secondary leading-relaxed">
        ...
        <div className="p-4 bg-pf-elevated border border-pf-border rounded-pf space-y-2">
          ...
          <p className="text-xs text-pf-text-secondary">
            ...
            See the <button onClick={() => navigate('mcp-server')} className="text-pf-cyan-400 hover:underline">MCP Server</button> section for setup.
          </p>
        </div>
      </div>
    );
    ...
    if (epSection) return (
      <div className="space-y-5">
        <SectionHeader title={epSection.title} />
        <div className="space-y-2">
    ...
    if (activeId === 'sse') return (
      <div className="space-y-5">
        <SectionHeader title="SSE Events" />
        <p className="text-sm text-pf-text-secondary leading-relaxed">
    ...
    if (activeId === 'webhook-signatures') return (
      <div className="space-y-5">
        <SectionHeader title="Webhook Signatures" />
        <p className="text-sm text-pf-text-secondary leading-relaxed">
    ...
    if (activeId === 'mcp-server') return (
      <div className="space-y-5">
        <SectionHeader title="MCP Server (Claude)" />
        <p className="text-sm text-pf-text-secondary leading-relaxed">

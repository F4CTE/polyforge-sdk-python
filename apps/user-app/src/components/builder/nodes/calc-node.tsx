...
function CalcNodeInner({ id, data }: NodeProps<CalcNode>) {
  ...
  return (
    <>
      ...
      <div
        className="builder-node-card w-[180px] rounded-pf shadow-elevation-2 overflow-hidden"
        style={{ '--node-color': CALC_COLOR } as React.CSSProperties}
      >
        {/* Header bar */}
        ...
        >
          ...
          {icon}
          <span className="text-label font-semibold flex-1 truncate">{displaySymbol}</span>
        ...
        <div className="px-3 py-2 space-y-2">
          {dropdownOptions && (
            <div>
              <label htmlFor={`${id}-${dropdownOptions.key}`} className="block text-caption font-medium text-tertiary mb-1 uppercase tracking-wider">
              ...
              <select
                ...
                className="w-full px-2 py-1 text-label bg-surface border border-subtle rounded-sm text-primary focus-visible:outline-none focus-visible:border-gain/50 transition-colors"
              >
          ...
          {showWindowField && (
            <div>
              <label htmlFor={`${id}-windowSize`} className="block text-caption font-medium text-tertiary mb-1 uppercase tracking-wider">
                Window (N ticks)
              </label>
              <input
                id={`${id}-windowSize`}
                ...
                className="w-full px-2 py-1 text-label bg-surface border border-subtle rounded-sm text-primary placeholder:text-tertiary/50 focus-visible:outline-none focus-visible:border-gain/50 transition-colors"
              />
            </div>
          )}
          ...
          {showBetweenFields && (
            <>
              <div>
                <label htmlFor={`${id}-min`} className="block text-caption font-medium text-tertiary mb-1 uppercase tracking-wider">
                  Min
                </label>
                <input
                  id={`${id}-min`}
              ...
              <div>
                <label htmlFor={`${id}-max`} className="block text-caption font-medium text-tertiary mb-1 uppercase tracking-wider">
                  Max
                </label>
                <input
                  id={`${id}-max`}
          ...
          {showDecimalsField && (
            <div>
              <label htmlFor={`${id}-decimals`} className="block text-caption font-medium text-tertiary mb-1 uppercase tracking-wider">
                Decimals
              </label>
              <input
                id={`${id}-decimals`}

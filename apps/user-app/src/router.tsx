        ...
        children: [
          ...
          // Verified routes
          {
            ...
            children: [
              ...
              { path: 'strategies/templates', lazy: () => import('./pages/strategies/templates-gallery') },
              { path: 'strategies/compare', lazy: () => import('./pages/strategies/strategy-compare') },
              ...
              { path: 'collections', lazy: () => import('./pages/collections/collections') },
              { path: 'collections/:id', lazy: () => import('./pages/collections/collection-detail') },

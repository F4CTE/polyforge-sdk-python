...
import { Search, ChevronLeft, ChevronRight, Check, X, Wifi, Shield } from 'lucide-react';
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody>
              {loading ? (
                <tr>
                  <td colSpan={7} className="px-4 py-8 text-center text-[var(--color-pf-text-tertiary)]">
                    Loading...
                  </td>
                </tr>
              ) : users.length === 0 ? (

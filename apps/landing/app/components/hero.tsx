    ...
    >
      ...
      <div className="relative z-10 max-w-[1100px] mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-8">
          <a
            href="/signup"
            className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-cyan-500 hover:bg-cyan-400 text-pf-text-contrast font-semibold text-pf-body transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-400"
          >
            Start Trading Free
          </a>
          <a
            href="#how-it-works"
            className="inline-flex items-center justify-center px-6 py-3 rounded-lg border border-cyan-500/40 hover:border-cyan-500/70 text-cyan-400 hover:text-cyan-300 font-semibold text-pf-body transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-400"
          >
            See How It Works
          </a>
        </div>

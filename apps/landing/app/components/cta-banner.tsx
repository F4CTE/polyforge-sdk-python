    ...
    <section className="py-24" aria-labelledby="cta-heading">
      <div className="max-w-pf-container-landing mx-auto px-6">
        <div className="relative overflow-hidden bg-pf-surface border border-pf-cyan-500/20 rounded-pf-lg px-6 sm:px-12 py-12 sm:py-16 text-center">
          ...
          <h2
            id="cta-heading"
            className="relative text-2xl sm:text-3xl lg:text-4xl font-semibold text-pf-text mb-4"
          >
          ...
          <a
            href="/signup"
            className="relative inline-flex items-center justify-center px-8 py-4 rounded-pf bg-pf-cyan-500 hover:bg-pf-cyan-400 text-pf-text-contrast font-semibold text-base transition-colors duration-pf-fast focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pf-cyan-400"
          >

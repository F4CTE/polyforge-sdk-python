    ...
    <section className="py-24" aria-labelledby="cta-heading">
      <div className="max-w-[1100px] mx-auto px-6">
        <div className="relative overflow-hidden bg-pf-surface border border-pf-cyan-500/20 rounded-pf-lg px-6 sm:px-12 py-12 sm:py-16 text-center">
          ...
          <a
            href="/signup"
            className="relative inline-flex items-center justify-center px-8 py-3.5 rounded-lg bg-cyan-500 hover:bg-cyan-400 text-pf-text-contrast font-semibold text-base transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-400"
          >
